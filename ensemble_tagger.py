#
#  Original source:
#   https://github.com/estnltk/estnltk/blob/b9e121ac4da34757656f93636de83a1186f21ac9/estnltk/taggers/syntax/stanza_tagger/ensemble_tagger.py
#
...
class StanzaSyntaxEnsembleTagger(Tagger):
    ...
    def __init__(self,
        ...
        if not model_paths:
            ...
            ensemble_path = os.path.join(dir, 'et', 'depparse', 'ensemble_models')
